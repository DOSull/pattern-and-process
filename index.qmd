...
## The model 'zoo'
To aid understanding, more than 50 specific models described in the book are available on this site for exploration in the freely available [NetLogo platform](http://patternandprocess.org/related-software-links/netlogo-information-and-download/). 
You can access the models with brief accompanying descriptions from the **Model 'zoo'** drop-down menu, organized by chapters.
...
You can get all the models in a [this zipped archive](https://github.com/DOSull/model-zoo/archive/refs/tags/v0.6.2.zip).
